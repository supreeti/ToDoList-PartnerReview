...
- [Live Demo Link](https://github.com/supreeti/ToDoList-PartnerReview/)
  Visit my project.
...
```sh
  cd my-folder
  git clone https://github.com/supreeti/ToDoList-PartnerReview.git
```
### Install
...
Feel free to check the [issues page](https://github.com/supreeti/ToDoList-PartnerReview/issues/new).
...
This project is [MIT](https://github.com/supreeti/ToDoList-PartnerReview/blob/main/LICENSE) licensed.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
